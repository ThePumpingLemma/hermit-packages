...
version "1.36.0" "cli-1.39.13" "cli-1.40.0" "cli-1.40.1" "cli-1.40.3" "cli-1.41.0"
        "cli-2.0.2" "cli-2.0.3" "cli-2.0.5" "cli-2.0.7" "cli-2.0.8" "cli-2.0.9" "cli-2.0.10"
        "cli-2.1.0" "cli-2.2.0" "cli-2.3.0" {
  auto-version {
